...
export const card = (object) => {
  ...
  <div class="card m-1" style="width: 18rem;">
    ...
    >
      ${object.favorite ? `<button id="fav-btn" type="button" class="btn">
      <i class="fa fa-heart" style="color:red;font-size:35px;"></i>
    </button>` : 
      `<button id="fav-btn" type="button" class="btn">
        <i class="fa fa-heart" style="color:white;font-size:35px;"></i>
      </button>`}
    </div>
    <div 
